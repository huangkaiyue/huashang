...
//#define TF_SYS_PATH 		"/media/mmcblk0/"		//tfå¡è·¯å¾„
...
#define INTERRUPT_NETWORK_FILE			"/var/interrupt.file"	//´ò¶ÏÅäÍø
...
#define PLAY_NEXT		1		//²¥·ÅÏÂÒ»Ê×¸èÇú
#define PLAY_PREV		2 		//²¥·ÅÉÏÒ»Ê×¸èÇú
